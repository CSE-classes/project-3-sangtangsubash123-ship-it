...
void *producer_thread(void *arg)
{
    ...
    */
    ...
    /*
       Lock only once when attaching local list
       to global list
    */
...
int main(int argc, char* argv[])
{
    ...
    NUM_PROCS = sysconf(_SC_NPROCESSORS_CONF); // get number of CPUs
    ...
    gettimeofday(&endtime, NULL); // get finish time
